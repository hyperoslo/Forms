...
- (void)testInputValidator {
    ...
    XCTAssertEqualObjects([field.inputValidator class], [NameInputValidator class]);
    ...
    XCTAssertEqualObjects([field.inputValidator class], [PhoneNumberInputValidator class]);
    ...
    XCTAssertEqualObjects([field.inputValidator class], [NumberInputValidator class]);
}
